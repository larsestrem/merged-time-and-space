var ML_C={"phases":{"question":"Why does the Moon change shape?","task":"Move the Moon around Earth. Watch the Moon itself stay half lit while the phase seen from Earth changes.","observe":"The dark part is lunar night, not Earth’s shadow.","control":"Moon’s angle from the Sun","min":0,"max":360,"step":1,"value":90,"presets":[["New",0],["First quarter",90],["Full",180],["Last quarter",270]]},"phase-names":{"question":"What are the Moon phases called?","task":"Move in eighths of an orbit and use the position, not just the shape, to learn each phase name.","observe":"Quarter means a quarter of the orbit, even though the disc looks half lit.","control":"Position in the phase cycle","min":0,"max":315,"step":45,"value":0,"presets":[["New",0],["First quarter",90],["Full",180],["Last quarter",270]]},"synodic-month":{"question":"Why is the phase month longer than one orbit?","task":"Stop first at one star-relative orbit, then continue until the Moon catches the Sun’s shifted direction.","observe":"Back to the same stars is not yet back to the same phase.","control":"Days since new moon","min":0,"max":29.5306,"step":0.1,"value":27.3,"presets":[["Start",0],["One orbit",27.3],["Same phase",29.5306]]},"tidal-locking":{"question":"What does tidal locking actually mean?","task":"Move the Moon around Earth, then compare one spin per orbit with no spin. Follow the gold mark.","observe":"A Moon that did not spin would show Earth every side during one orbit.","control":"Position around Earth","min":0,"max":360,"step":1,"value":120,"presets":[["Start",0],["Quarter lap",90],["Half lap",180],["Full lap",360]],"optionLabel":"Moon’s spin","optionValue":"locked","options":[["locked","One spin per orbit"],["none","No spin"],["double","Two spins per orbit"]]},"libration":{"question":"How can a locked Moon appear to wobble?","task":"Move through the slightly elliptical orbit. Compare the steady spin angle with the changing orbital speed.","observe":"Near perigee the Moon moves faster but its spin does not speed up to match.","control":"Position in the orbit","min":0,"max":360,"step":1,"value":90,"presets":[["Perigee",0],["Quarter",90],["Apogee",180],["Three quarters",270]]},"moonrise-later":{"question":"Why does moonrise get later each night?","task":"Advance one night at a time. Watch how much extra Earth must turn to face the Moon again.","observe":"The roughly 50-minute delay is the Moon’s daily orbital step converted into Earth-rotation time.","control":"Nights after the first observation","min":0,"max":7,"step":1,"value":1,"presets":[["First night",0],["Next night",1],["Three nights",3],["One week",7]]},"eclipse-tilt":{"question":"Why isn’t there an eclipse every month?","task":"Set the orbit to 0°, then restore its real tilt. Watch the Moon move off the exact Sun–Earth line.","observe":"Phase controls left–right alignment; orbital tilt controls the missing up–down dimension.","control":"Moon-orbit tilt","min":0,"max":5.1,"step":0.1,"value":5.1,"presets":[["Flat orbit",0],["Half tilt",2.5],["Real tilt",5.1]],"optionLabel":"Alignment","optionValue":"full","options":[["full","Full moon — Earth’s shadow"],["new","New moon — the Sun"]]},"supermoon":{"question":"How much difference does Moon distance make?","task":"Move from the closest to the farthest part of the orbit. Compare apparent width and brightness side by side.","observe":"The size change is subtle; the brightness change is easier to measure.","control":"Position from closest to farthest","min":0,"max":100,"step":1,"value":0,"presets":[["Closest",0],["Middle",50],["Farthest",100]]},"blue-moon":{"question":"When can one month contain two full moons?","task":"Move the first full moon through the month. Find the latest starting day that still leaves room for another.","observe":"The Moon does nothing unusual. A calendar box happens to be slightly longer than the phase cycle.","control":"Day of the first full moon","min":1,"max":31,"step":1,"value":1,"presets":[["Day 1",1],["Day 2",2],["Day 3",3],["Day 10",10]],"optionLabel":"Days in the month","optionValue":"31","options":[["28","28 days"],["29","29 days"],["30","30 days"],["31","31 days"]]},"dark-side":{"question":"Is the far side always dark?","task":"Move through the phase cycle. Compare the arrow toward Earth with the arrow toward the Sun.","observe":"Far side is a fixed hemisphere; dark side is whichever hemisphere faces away from sunlight now.","control":"Moon’s angle from the Sun","min":0,"max":360,"step":1,"value":0,"presets":[["New",0],["First quarter",90],["Full",180],["Last quarter",270]]},"_constants":{"sid":27.3,"syn":29.5306,"tilt":5.1,"near":356700,"far":406600}};
