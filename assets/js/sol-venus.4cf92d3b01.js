...
function solSvg(ms,rungId,opt){
  ...
  var SOL_HAS={"core":1,"globe":1,"moon":0,"sat":0,"small":0,"transfer":0};
  ...
  var CFG={"rung":"inner","path":"/venus-simulator/","tilt":50};
    ...
    if(L){
      if(!TARGET){ L.hidden=true; L.innerHTML=''; }
        ...
        L.innerHTML='Flying to <b>'+plName(TARGET)+'</b>. '
          +'<a href="'+DEST_SLUG[TARGET]+'">Everything about '+plName(TARGET)+' →</a>'; }
    }
  }
  var db=$('sol-dests');
