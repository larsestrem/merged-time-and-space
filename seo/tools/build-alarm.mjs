...
<div class="wrap">
  ...
  <div class="card tool-about" id="ac-instructions">
    ...
    <p>Using it in a classroom? The <a href="/classroom/">classroom timer &amp; stopwatch guide</a> covers full screen on a projector, keyboard shortcuts and what to test before a lesson depends on it.</p>
  </div>
