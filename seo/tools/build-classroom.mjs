  ...
  "solar-system": {
    ...
    "high-school": {
      ...
      steps: [
        ...
        ["Task 4 · 8 min", `Do Jupiter and Saturn: why do their windows come nearly every year? (T₂ huge → synodic period → T₁. The formula says outer-planet windows converge on Earth's own year.) Check against <a href="${ROCKET_PATH}">the solved list</a>.`],
