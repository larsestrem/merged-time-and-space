...
import {
  SIDEREAL, ORBIT_TILT,
  SYS_RS, SYS_REO, SYS_RE, SYS_RMO, SYS_RM,
  SYS_INC_DRAWN, sysOrbitWidget,
 ...
 * SIDEREAL and ORBIT_TILT live in system-orbit.mjs — the figure that
 * actually animates the ratio — and are re-exported from this file so
 * home's "27.3-day orbit" label cannot drift from it. */
const SYNODIC = "29.53";
 ...
 * circles is a drawing choice. The figure itself lives in system-orbit.mjs
 * so /concepts/why-do-we-have-seasons/ can show the same drawing.
 * ------------------------------------------------------------------------- */
